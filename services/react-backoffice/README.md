...
This is a react application, bootstrapped with  [Create React App](https://github.com/facebookincubator/create-react-app).

Then the [Admin-On-REST](https://github.com/marmelab/admin-on-rest) packaged is added to throw the UI basics and facilitate basic CRUD functions. See the documentation [here](https://marmelab.com/admin-on-rest/)
...
Otherwise, you can use ```docker run -p 3000:3000 .``` in this directory or ```docker-compose up``` in the main directory (```cd ../..```)
