...
class SideBar extends Component {
  ...
  constructor(props) {
    ...
    this.watchSettings = this.watchSettings.bind(this)
  }
  ...
  watchSettings() {
    setInterval(() => {
      if(global.settings && this.state.showAll !== global.settings.fullMenu) {
        this.state.showAll = global.settings.fullMenu;
        this.forceUpdate();
      }
    }, 500);
  }
  ...
  generateList() {
    return (
      <List
        dataArray={this.state.showAll ? datas : mandatoryDatas} renderRow={data =>
